...
bool TieBreakingNodePointerComaprator::operator()(const searchNode *a,
...
void OneQueueWAStarFringe::push(searchNode *n) {
  ...
  switch (aStarOption) {
  case gValNone: /* nothing to do */
    break;
  case gValPathCosts:
    n->fValue += n->modificationDepth;
    break;
  case gValActionCosts:
    n->fValue += n->actionCosts;
    break;
  case gValActionPathCosts:
    n->fValue += n->mixedModificationDepth;
    break;
  }
...
void OneQueueWAStarFringe::printTypeInfo() {
  if (aStarOption == gValNone) {
    ...
    case gValPathCosts:
      ...
      break;
    case gValActionCosts:
      cout << "- Distance G is \"action costs\"" << endl;
      break;
    case gValActionPathCosts:
      cout << "- Distance G is \"action costs\" + \"number of decompositions\""
           << endl;
      break;
    case gValNone: /* cannot happen */
      break;
    }
  }
}
