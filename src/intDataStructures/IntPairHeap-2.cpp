...
void IntPairHeap::clear() { nextIndex = 1; }

bool IntPairHeap::isEmpty() { return nextIndex == 1; }

int IntPairHeap::size() { return (nextIndex - 1); }
...
tHVal IntPairHeap::topVal() { return vals[1]; }

tHVal IntPairHeap::topKey() { return keys[1]; }
