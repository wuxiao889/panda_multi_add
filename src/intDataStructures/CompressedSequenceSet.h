...
struct compressed_sequence_trie {
  ...
  compressed_sequence_trie(const vector<uint64_t> &sequence, int paddingBits,
                           void **&p);
...
private:
  ...
  compressed_sequence_trie();
  compressed_sequence_trie(const vector<uint64_t> &sequence, int startingBlock,
                           int startingBit, int paddingBits, void **&p);
