...
bool bIntSet::isEmpty() { return currentSize == 0; }
...
int bIntSet::getSize() { return currentSize; }
...
bool bIntSet::get(int i) { return boolContainer[i]; }

void bIntSet::sortSet() { sort(intContainer, 0, currentSize - 1); }
