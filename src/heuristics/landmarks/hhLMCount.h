...
public:
  ...
  const int fTask =
      0; // state feature of new model that belonged to task in original HTN
  const int fFact = 1; // state feature of new model that belonged to state
                       // feature in original HTN
